...
<p>Figure 2: The above figure shows the process of how our system takes in user input and processes the light intensity to send data from pico to PC, convert it into song form, and output data again over wifi to play on the pico.</p>
...
At first, all of the project updates were made in the main branch. This was mainly for ease of use and simplicity. Following the first agile sprint, we had an IDR with Ryan, in which he questioned our method of having a singular branch that all the work was done in. He advised us that it would be “right” to have separate branches so we can push to main separately, and that the main branch should be reserved for tested and verified code. Each of the project’s contributors should have their own branch where they work on developing new features, testing code, or fixing bugs. Once a person is confident that their code works, they can request to merge into the main branch. He also advised that the main code should be more protected, and he suggested a system in which one or two other people have to approve the changes to officially merge the code. 
