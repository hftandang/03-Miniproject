...
# Testing
Since the pico was provided to us without MicroPython installed, we wanted a way to test that MicroPython was installed correctly. Thus, we ran a script to blink the built-in LED on the Pico (blink.py) to verify MicroPython was installed correctly and that our Pico wasn't broken.
